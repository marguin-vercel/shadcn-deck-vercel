...
export const MadeForDevelopersSlide: SlideDefinition = {
	slug: 'made-for-developers-slide',
	component: SlideComponent,
	notes: 'What if slides were built for developers?',
	title: 'What if slides were built for developers?',
};

function SlideComponent() {
	return (
		<Slide contentPosition="center" padding='large'>
			<Heading size="2xl" mb='md'>What if slides were built for developers?</Heading>
