...
export const IntroducingVercelDeck: SlideDefinition = {
	slug: 'introducing-vercel-deck',
	component: SlideComponent,
	notes: 'Introducing Vercel Deck - a Vercel-styled version of shadcn/deck for modern presentations.',
	title: 'Introducing Vercel Deck',
};
...
function SlideComponent() {
	return (
		<Slide contentPosition="center" padding='large'>
			...
			>
				This presentation was built using Vercel Deck - a Vercel-styled version of shadcn/deck,
				a modern presentation system using Next.js and shadcn/ui components
			</Text>
			<div className="mt-10 flex justify-center space-x-4">
				<Button variant="outline" size="xl" asChild>
					<Link href="https://github.com/consentdotio/shadcn-deck">
					<svg
							xmlns="http://www.w3.org/2000/svg"
							className="size-5"
							viewBox="0 0 640 640"
						>
							...
							/>
						</svg> Original: consentdotio/shadcn-deck
					</Link>
				</Button>
			</div>
		</Slide>
